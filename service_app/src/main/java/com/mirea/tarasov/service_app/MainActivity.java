package com.mirea.tarasov.service_app;
...
import com.mirea.tarasov.service_app.databinding.ActivityMainBinding;
        ...
        binding.button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (play == false) {
                    ...
                    binding.textView1.setText("toxin");
                    binding.textView2.setText("benedixhion");
                    binding.image.setImageResource(R.drawable.toxin);
                    ...
                    binding.image.setImageResource(R.drawable._948448);
                    play = false;
                }
            }
        });
